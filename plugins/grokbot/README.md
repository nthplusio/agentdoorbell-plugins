...
Manage your Agent Doorbell notifiers and handle account-level Gmail wake-up signals. This package uses the Cursor plugin format and is awaiting actual Grok Bot installation/OAuth acceptance.

## Connect

1. Sign in at https://agentdoorbell.com using an invited email address. Connect Gmail and configure your notifier on the website.
